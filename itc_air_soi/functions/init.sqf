...
{[nil] call itc_air_steerpoints_fnc_store;},"",[207, [false, false, false]]] call CBA_fnc_addKeybind;
...
{call itc_air_soi_fnc_up;}, [208, [false, true, false]],true] call CBA_fnc_addKeybind;
