...
_options pushBack [_vehicle,"ROVER_FREQ",_roverFreq,"ROVER FREQ",{},"UFC",{((parseNumber _this) > 5240 && (parseNumber _this) < 5850)}, false];
_vehicle setVariable ["ITC_AIR_BROADCASTING",false];
