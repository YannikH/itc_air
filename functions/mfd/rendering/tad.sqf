...
_map drawIcon ["itc_air\data\UI\WPT32.paa", [1,1,1,1], ((_plane getVariable "tgp_dir") select 1),  15,15, 0,  ".", 0, 0.01];
_map drawIcon ["itc_air\data\UI\PLN32.paa", [1,1,1,1], getPos _plane,  45,45, getDir _plane,  ".", 0, 0.01];
_map drawIcon ["itc_air\data\UI\CTR32.paa", [1,1,1,1], (_centerPos vectorAdd ((_display getVariable "tad_cursor") vectorMultiply _fov)),  15,15, 0,  ".", 0, 0.01];
...
{
    _map drawIcon ["itc_air\data\UI\WP32.paa", [1,1,1,1], _x select 1,  15,15, 0,  ".", 0, 0.01];
}forEach _waypoints;
